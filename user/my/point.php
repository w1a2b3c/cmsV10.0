            ...
            <div class="box-base box-user ui-row">
                ...
                <div class="ui-col-10 ui-pl-30 ui-pr-30 ui-pb-15">
                    ...
                    <div class="ui-menu ui-menu-blue ui-mt-15 ui-mb-20">
                        <div class="ui-menu-name">积分明细</div>
                    </div>
                    
                    <div class="ui-btn-group ui-btn-group-yellow ui-btn-group-bg">
                        <a class="ui-btn-group-item{if $type==0} active{/if}" href="{N('mypoint')}">全部</a>
                        <a class="ui-btn-group-item{if $type==1} active{/if}" href="{N('mypoint','','type=1')}">收入</a>
                        <a class="ui-btn-group-item{if $type==2} active{/if}" href="{N('mypoint','','type=2')}">支出</a>
                    </div>
                    ...
                    <table class="ui-table ui-table-border ui-table-hover ui-mt-15">
                        ...
                        <tbody>
                        {sdcms:rs pagesize="20" table="sd_user_point" where="$where" order="aid desc" key="aid"}
                        {rs:eof}
                        <tr>
                        ...
                        <tr>
                            ...
                            <td>{$rs[oldpoint]}</td>
                            <td>{iif($rs[types]==1,'+','<span class="ui-text-gray">-</span>')} {$rs[point]}</td>
                            <td>{$rs[newpoint]}</td>
